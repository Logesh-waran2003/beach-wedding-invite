 ...
 */
import { A as $PROXY, B as createResource, C as render, F as batch, G as on, H as createSignal, I as createComponent, K as onCleanup, L as createEffect, R as createMemo, S as memo, U as getListener, V as createRoot, a as isMac, g as isElementConnected, h as isKeyboardEventTriggeredByInput, i as isEventFromOverlay, j as $TRACK, m as hasTextSelectionOnPage, n as saveToolbarState, p as hasTextSelectionInInput, r as resolveActionEnabled, s as clampToRange, t as loadToolbarState } from "./state-1l6R0bBh.js";
import { $ as OFFSCREEN_POSITION, D as resolveSource, E as getStackContext, F as detectCspNonce, I as getTagName, L as ARROW_KEYS, M as nativeRequestAnimationFrame, N as waitUntilNextFrame, O as stripInternalAttributes, P as hideFromThirdParties, Q as NEXTJS_REVALIDATION_DELAY_MS, S as getElementContext, V as DRAG_SELECTION_COVERAGE_THRESHOLD, W as FEEDBACK_DURATION_MS, X as MODIFIER_KEYS, Y as MAX_SESSION_STORAGE_SIZE_BYTES, Z as MOUNT_ROOT_RECHECK_DELAY_MS, _ as clearVisibilityCache, a as freezeGlobalAnimations, b as checkIsNextProject, c as clearElementPositionCache, d as buildElementAtPointIndex, dt as TOOLBAR_DEFAULT_POSITION_RATIO, f as destroyElementAtPointIndex, g as unfreezePseudoStates, gt as Z_INDEX_OVERLAY, h as suspendPointerEventsFreeze, ht as ZOOM_DETECTION_THRESHOLD, i as freezeAnimations, j as nativeCancelAnimationFrame, l as getElementAtPosition, m as resumePointerEventsFreeze, mt as VERSION, n as logRecoverableError, o as unfreezeGlobalAnimations, p as freezePseudoStates, r as freezeAllAnimations, s as openFile, t as freezeUpdates, u as getElementsAtPoint, v as isValidGrabbableElement, w as getNearestComponentName, x as getComponentDisplayName, y as isRootElement, z as DEFAULT_ACTION_ID } from "./freeze-updates-D0epnknV.js";
import { n as extractElementCss, r as createElementSelector, t as disposeBaselineStyles } from "./extract-element-css-sRy_JFJn.js";
...
const init = (rawOptions) => {
	...
	return createRoot((dispose) => {
		...
		if (pluginRegistry.store.theme.enabled) import("./renderer-CPDniDri.js").then(({ ReactGrabRenderer }) => {
			if (disposed) return;
