...
const init = (rawOptions) => {
	...
	return createRoot((dispose) => {
		...
		if (pluginRegistry.store.theme.enabled) import("./renderer-B1o0daXv.js").then(({ ReactGrabRenderer }) => {
			if (disposed) return;
