...
const SPATIAL_INDEX_ROOT_MARGIN_PX = 1e4;
...
//#endregion
//#region src/utils/spatial-index.ts
...
const querySpatialIndex = (clientX, clientY) => {
...
const isSpatialIndexReady = () => currentIndex !== null;
const destroySpatialIndex = () => {
	if (pendingObserver) {
