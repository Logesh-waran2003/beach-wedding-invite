...
const isDecorativeOverlay = (element, computedPosition) => (computedPosition === "absolute" || computedPosition === "fixed" || computedPosition === "sticky") && !REPLACED_TAGS.has(element.tagName) && element.childElementCount === 0 && (element.textContent?.trim().length ?? 0) === 0;
