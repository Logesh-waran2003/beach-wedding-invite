...
const getElementAtPosition = (clientX, clientY) => {
	...
	if (cache) {
		...
		if (isPositionClose || isWithinThrottle) {
			if (cache.element === null || cache.element.isConnected) return cache.element;
			cache = null;
		}
	}
...
//#endregion
export { OPACITY_CONVERGENCE_THRESHOLD as $, nativeCancelAnimationFrame as A, DRAG_SELECTION_COVERAGE_THRESHOLD as B, getHTMLPreview as C, resolveSource as D, getStackContext as E, getTagName as F, HINT_FLIP_IN_ANIMATION as G, DROPDOWN_OFFSCREEN_POSITION as H, ARROW_KEYS as I, MAX_SESSION_STORAGE_SIZE_BYTES as J, LERP_CONVERGENCE_THRESHOLD_PX as K, ARROW_MAX_LABEL_WIDTH_RATIO as L, waitUntilNextFrame as M, hideFromThirdParties as N, Te$1 as O, detectCspNonce as P, OFFSCREEN_POSITION as Q, DEFAULT_ACTION_ID as R, getElementContext as S, getStack as T, FEEDBACK_DURATION_MS as U, DROPDOWN_EDGE_TRANSFORM_ORIGIN as V, FROZEN_GLOW_COLOR as W, MOUNT_ROOT_RECHECK_DELAY_MS as X, MODIFIER_KEYS as Y, NEXTJS_REVALIDATION_DELAY_MS as Z, clearVisibilityCache as _, supportsDisplayP3 as _t, freezeGlobalAnimations as a, OVERLAY_FILL_COLOR_INSPECT as at, checkIsNextProject as b, clearElementPositionCache as c, SELECTION_LABEL_OFFSCREEN_PX as ct, buildElementAtPointIndex as d, TOOLBAR_SHAKE_TOOLTIP_DURATION_MS as dt, OVERLAY_BORDER_COLOR_DEFAULT as et, destroyElementAtPointIndex as f, TOOLTIP_BASE_CLASS as ft, unfreezePseudoStates as g, Z_INDEX_OVERLAY_CANVAS as gt, suspendPointerEventsFreeze as h, Z_INDEX_OVERLAY as ht, freezeAnimations as i, OVERLAY_FILL_COLOR_DRAG as it, nativeRequestAnimationFrame as j, Z$1 as k, getElementAtPosition as l, SELECTION_LERP_FACTOR as lt, resumePointerEventsFreeze as m, ZOOM_DETECTION_THRESHOLD as mt, logRecoverableError as n, OVERLAY_BORDER_COLOR_INSPECT as nt, unfreezeGlobalAnimations as o, RELEVANT_CSS_PROPERTIES as ot, freezePseudoStates as p, VERSION as pt, MAX_SELECTOR_COMBINATIONS as q, freezeAllAnimations as r, OVERLAY_FILL_COLOR_DEFAULT as rt, openFile as s, SELECTION_HINT_CYCLE_INTERVAL_MS as st, freezeUpdates as t, OVERLAY_BORDER_COLOR_DRAG as tt, getElementsAtPoint as u, TOOLBAR_DEFAULT_POSITION_RATIO as ut, isValidGrabbableElement as v, getNearestComponentName as w, getComponentDisplayName as x, isRootElement as y, DRAG_LERP_FACTOR as z };