 ...
 */
const require_state = require('./state-Ri43Ul3l.cjs');
const require_freeze_updates = require('./freeze-updates-D3G5iWxc.cjs');
const require_extract_element_css = require('./extract-element-css-D5aA68tO.cjs');
...
const init = (rawOptions) => {
	...
	return require_state.createRoot((dispose) => {
		...
		if (pluginRegistry.store.theme.enabled) Promise.resolve().then(() => require("./renderer-Ba4PVq9d.cjs")).then(({ ReactGrabRenderer }) => {
			if (disposed) return;
