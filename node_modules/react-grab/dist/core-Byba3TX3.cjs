 ...
 */
const require_state = require('./state-CWt-mBJL.cjs');
const require_freeze_updates = require('./freeze-updates-D_6b9L7B.cjs');
const require_extract_element_css = require('./extract-element-css-Cm9mwT-P.cjs');
...
const init = (rawOptions) => {
	...
	return require_state.createRoot((dispose) => {
		...
		if (pluginRegistry.store.theme.enabled) Promise.resolve().then(() => require("./renderer-CV5Vr5vz.cjs")).then(({ ReactGrabRenderer }) => {
			if (disposed) return;
