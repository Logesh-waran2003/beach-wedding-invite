 ...
 */
import { A as $PROXY, B as createResource, C as render, F as batch, G as on, H as createSignal, I as createComponent, K as onCleanup, L as createEffect, R as createMemo, S as memo, U as getListener, V as createRoot, a as isMac, g as isElementConnected, h as isKeyboardEventTriggeredByInput, i as isEventFromOverlay, j as $TRACK, m as hasTextSelectionOnPage, n as saveToolbarState, p as hasTextSelectionInInput, r as resolveActionEnabled, s as clampToRange, t as loadToolbarState } from "./state-U1eJcxmh.js";
import { A as nativeRequestAnimationFrame, C as getNearestComponentName, E as resolveSource, F as ARROW_KEYS, H as FEEDBACK_DURATION_MS, J as MODIFIER_KEYS, L as DEFAULT_ACTION_ID, M as hideFromThirdParties, N as detectCspNonce, P as getTagName, T as getStackContext, X as NEXTJS_REVALIDATION_DELAY_MS, Y as MOUNT_ROOT_RECHECK_DELAY_MS, Z as OFFSCREEN_POSITION, _ as isValidGrabbableElement, a as freezeGlobalAnimations, b as getComponentDisplayName, c as clearElementPositionCache, d as destroyPrehitIndex, f as freezePseudoStates, ft as VERSION, g as clearVisibilityCache, h as unfreezePseudoStates, i as freezeAnimations, j as waitUntilNextFrame, k as nativeCancelAnimationFrame, l as getElementAtPosition, lt as TOOLBAR_DEFAULT_POSITION_RATIO, m as suspendPointerEventsFreeze, mt as Z_INDEX_OVERLAY, n as logRecoverableError, o as unfreezeGlobalAnimations, p as resumePointerEventsFreeze, pt as ZOOM_DETECTION_THRESHOLD, q as MAX_SESSION_STORAGE_SIZE_BYTES, r as freezeAllAnimations, s as openFile, t as freezeUpdates, u as getElementsAtPoint, v as isRootElement, x as getElementContext, y as checkIsNextProject, z as DRAG_SELECTION_COVERAGE_THRESHOLD } from "./freeze-updates-djFKjrMV.js";
import { n as extractElementCss, r as createElementSelector, t as disposeBaselineStyles } from "./extract-element-css-CkA9WKrg.js";
...
const init = (rawOptions) => {
	...
	return createRoot((dispose) => {
		...
		if (pluginRegistry.store.theme.enabled) import("./renderer-BOuWzOLo.js").then(({ ReactGrabRenderer }) => {
			if (disposed) return;
