...
const isDecorativeOverlay = (element, computedPosition) => (computedPosition === "absolute" || computedPosition === "sticky") && element.childElementCount === 0 && (element.textContent?.trim().length ?? 0) === 0;
