...
const queryElementAtPointIndex = (clientX, clientY) => {
	...
	for (const hitIndex of hitIndices) {
		...
		if (candidate.area < bestElement.area) bestElement = candidate;
		else if (candidate.area === bestElement.area && candidate.treeOrder > bestElement.treeOrder) bestElement = candidate;
	}
