 ...
 */
import { A as $PROXY, B as createResource, C as render, F as batch, G as on, H as createSignal, I as createComponent, K as onCleanup, L as createEffect, R as createMemo, S as memo, U as getListener, V as createRoot, a as isMac, g as isElementConnected, h as isKeyboardEventTriggeredByInput, i as isEventFromOverlay, j as $TRACK, m as hasTextSelectionOnPage, n as saveToolbarState, p as hasTextSelectionInInput, r as resolveActionEnabled, s as clampToRange, t as loadToolbarState } from "./state-DWNWo7_Q.js";
import { A as nativeRequestAnimationFrame, E as stripInternalAttributes, F as ARROW_KEYS, H as ELEMENT_AT_POINT_INDEX_ROOT_MARGIN_PX, J as MAX_SESSION_STORAGE_SIZE_BYTES, L as DEFAULT_ACTION_ID, M as hideFromThirdParties, N as detectCspNonce, P as getTagName, Q as OFFSCREEN_POSITION, S as getNearestComponentName, T as resolveSource, U as FEEDBACK_DURATION_MS, X as MOUNT_ROOT_RECHECK_DELAY_MS, Y as MODIFIER_KEYS, Z as NEXTJS_REVALIDATION_DELAY_MS, _ as isRootElement, a as freezeGlobalAnimations, b as getElementContext, c as clearElementPositionCache, d as freezePseudoStates, f as resumePointerEventsFreeze, g as isValidGrabbableElement, h as clearVisibilityCache, ht as Z_INDEX_OVERLAY, i as freezeAnimations, j as waitUntilNextFrame, k as nativeCancelAnimationFrame, l as getElementAtPosition, m as unfreezePseudoStates, mt as ZOOM_DETECTION_THRESHOLD, n as logRecoverableError, o as unfreezeGlobalAnimations, p as suspendPointerEventsFreeze, pt as VERSION, r as freezeAllAnimations, s as openFile, t as freezeUpdates, u as getElementsAtPoint, ut as TOOLBAR_DEFAULT_POSITION_RATIO, v as checkIsNextProject, w as getStackContext, y as getComponentDisplayName, z as DRAG_SELECTION_COVERAGE_THRESHOLD } from "./freeze-updates-RQFpfUiW.js";
import { n as extractElementCss, r as createElementSelector, t as disposeBaselineStyles } from "./extract-element-css-DGvVuN5Y.js";
...
const init = (rawOptions) => {
	...
	return createRoot((dispose) => {
		...
		if (pluginRegistry.store.theme.enabled) import("./renderer-hTQdxCo_.js").then(({ ReactGrabRenderer }) => {
			if (disposed) return;
