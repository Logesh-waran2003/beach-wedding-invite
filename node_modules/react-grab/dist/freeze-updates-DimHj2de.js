...
const BOX_MODEL_MARGIN_HATCH_COLOR = overlayColor(.6);
const BOX_MODEL_PADDING_FILL_COLOR = overlayColor(.15);
const BOX_MODEL_CONTENT_FILL_COLOR = overlayColor(.04);
const BOX_MODEL_GAP_HATCH_COLOR = overlayColor(.45);
const BOX_MODEL_GAP_THRESHOLD_PX = .5;
...
//#endregion
export { MOUNT_ROOT_RECHECK_DELAY_MS as $, waitUntilNextFrame as A, BOX_MODEL_PADDING_FILL_COLOR as B, getStack as C, Z$1 as D, Te$1 as E, ARROW_MAX_LABEL_WIDTH_RATIO as F, DROPDOWN_OFFSCREEN_POSITION as G, DRAG_LERP_FACTOR as H, BOX_MODEL_CONTENT_FILL_COLOR as I, HINT_FLIP_IN_ANIMATION as J, FEEDBACK_DURATION_MS as K, BOX_MODEL_GAP_HATCH_COLOR as L, detectCspNonce as M, getTagName as N, nativeCancelAnimationFrame as O, ARROW_KEYS as P, MODIFIER_KEYS as Q, BOX_MODEL_GAP_THRESHOLD_PX as R, getNearestComponentName as S, resolveSource as T, DRAG_SELECTION_COVERAGE_THRESHOLD as U, DEFAULT_ACTION_ID as V, DROPDOWN_EDGE_TRANSFORM_ORIGIN as W, MAX_SELECTOR_COMBINATIONS as X, LERP_CONVERGENCE_THRESHOLD_PX as Y, MAX_SESSION_STORAGE_SIZE_BYTES as Z, isRootElement as _, Z_INDEX_OVERLAY_CANVAS as _t, freezeGlobalAnimations as a, OVERLAY_FILL_COLOR_DEFAULT as at, getElementContext as b, clearElementPositionCache as c, SELECTION_HINT_CYCLE_INTERVAL_MS as ct, freezePseudoStates as d, TOOLBAR_DEFAULT_POSITION_RATIO as dt, NEXTJS_REVALIDATION_DELAY_MS as et, resumePointerEventsFreeze as f, TOOLBAR_SHAKE_TOOLTIP_DURATION_MS as ft, isValidGrabbableElement as g, Z_INDEX_OVERLAY as gt, clearVisibilityCache as h, ZOOM_DETECTION_THRESHOLD as ht, freezeAnimations as i, OVERLAY_BORDER_COLOR_DRAG as it, hideFromThirdParties as j, nativeRequestAnimationFrame as k, getElementAtPosition as l, SELECTION_LABEL_OFFSCREEN_PX as lt, unfreezePseudoStates as m, VERSION as mt, logRecoverableError as n, OPACITY_CONVERGENCE_THRESHOLD as nt, unfreezeGlobalAnimations as o, OVERLAY_FILL_COLOR_DRAG as ot, suspendPointerEventsFreeze as p, TOOLTIP_BASE_CLASS as pt, FROZEN_GLOW_COLOR as q, freezeAllAnimations as r, OVERLAY_BORDER_COLOR_DEFAULT as rt, openFile as s, RELEVANT_CSS_PROPERTIES as st, freezeUpdates as t, OFFSCREEN_POSITION as tt, getElementsAtPoint as u, SELECTION_LERP_FACTOR as ut, checkIsNextProject as v, supportsDisplayP3 as vt, getStackContext as w, getHTMLPreview as x, getComponentDisplayName as y, BOX_MODEL_MARGIN_HATCH_COLOR as z };