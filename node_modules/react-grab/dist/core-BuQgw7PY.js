 ...
 */
import { A as $PROXY, B as createResource, C as render, F as batch, G as on, H as createSignal, I as createComponent, K as onCleanup, L as createEffect, R as createMemo, S as memo, U as getListener, V as createRoot, a as isMac, g as isElementConnected, h as isKeyboardEventTriggeredByInput, i as isEventFromOverlay, j as $TRACK, m as hasTextSelectionOnPage, n as saveToolbarState, p as hasTextSelectionInInput, r as resolveActionEnabled, s as clampToRange, t as loadToolbarState } from "./state-DJ7PjPaA.js";
import { A as nativeCancelAnimationFrame, B as DRAG_SELECTION_COVERAGE_THRESHOLD, D as resolveSource, E as getStackContext, F as getTagName, I as ARROW_KEYS, J as MAX_SESSION_STORAGE_SIZE_BYTES, M as waitUntilNextFrame, N as hideFromThirdParties, P as detectCspNonce, Q as OFFSCREEN_POSITION, R as DEFAULT_ACTION_ID, S as getElementContext, U as FEEDBACK_DURATION_MS, X as MOUNT_ROOT_RECHECK_DELAY_MS, Y as MODIFIER_KEYS, Z as NEXTJS_REVALIDATION_DELAY_MS, _ as clearVisibilityCache, a as freezeGlobalAnimations, b as checkIsNextProject, c as clearElementPositionCache, d as buildElementAtPointIndex, f as destroyElementAtPointIndex, g as unfreezePseudoStates, h as suspendPointerEventsFreeze, ht as Z_INDEX_OVERLAY, i as freezeAnimations, j as nativeRequestAnimationFrame, l as getElementAtPosition, m as resumePointerEventsFreeze, mt as ZOOM_DETECTION_THRESHOLD, n as logRecoverableError, o as unfreezeGlobalAnimations, p as freezePseudoStates, pt as VERSION, r as freezeAllAnimations, s as openFile, t as freezeUpdates, u as getElementsAtPoint, ut as TOOLBAR_DEFAULT_POSITION_RATIO, v as isValidGrabbableElement, w as getNearestComponentName, x as getComponentDisplayName, y as isRootElement } from "./freeze-updates-BbBuSULb.js";
import { n as extractElementCss, r as createElementSelector, t as disposeBaselineStyles } from "./extract-element-css-I11x58Zh.js";
...
const init = (rawOptions) => {
	...
	return createRoot((dispose) => {
		...
		if (pluginRegistry.store.theme.enabled) import("./renderer-maag68hV.js").then(({ ReactGrabRenderer }) => {
			if (disposed) return;
