...
const PREHIT_ROOT_MARGIN_PX = 1e4;
...
const queryPrehitIndex = (clientX, clientY) => {
...
const isPrehitIndexReady = () => currentIndex !== null;
const destroyPrehitIndex = () => {
	if (pendingObserver) {
