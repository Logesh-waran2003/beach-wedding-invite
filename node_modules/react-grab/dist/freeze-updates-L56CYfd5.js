...
const isValidGrabbableElement$1 = (element) => {
...
const buildPrehitIndex = () => {
	...
	for (const indexedRect of rects) tree.add(indexedRect.left, indexedRect.top, indexedRect.right, indexedRect.bottom);
	tree.finish();
	currentIndex = {
		tree,
		elements
...
const getElementAtPosition = (clientX, clientY) => {
	...
	for (const candidateElement of elementsAtPoint) {
		if (!isValidGrabbableElement$1(candidateElement)) continue;
