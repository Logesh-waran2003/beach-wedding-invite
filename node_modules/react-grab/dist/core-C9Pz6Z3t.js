	...
	return createRoot((dispose) => {
		...
		createEffect(on(isActivated, (activated, previousActivated) => {
			if (activated && !previousActivated) {
				...
				nativeRequestAnimationFrame(() => buildPrehitIndex());
		...
		if (pluginRegistry.store.theme.enabled) import("./renderer-DLhBUZeD.js").then(({ ReactGrabRenderer }) => {
			if (disposed) return;
