...
const freezePseudoStates = (cursorX, cursorY) => {
	...
	const hoverStates = [];
	const hoveredElements = cursorX !== void 0 && cursorY !== void 0 ? collectHoveredElements(cursorX, cursorY) : Array.from(document.querySelectorAll(":hover")).filter((element) => element instanceof HTMLElement);
...
const buildElementAtPointIndex = () => {
	...
	const treeOrderMap = /* @__PURE__ */ new Map();
	let treeOrder = 0;
	...
	const observer = new IntersectionObserver((entries) => {
		...
		for (const entry of entries) {
			...
			const elementArea = targetElement.clientWidth * targetElement.clientHeight || boundingRect.width * boundingRect.height;
