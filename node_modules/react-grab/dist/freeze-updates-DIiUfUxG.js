...
let accumulatedRects = [];
const rebuildFromAccumulated = () => {
...
const buildPrehitIndex = () => {
	...
	const observer = new IntersectionObserver((entries) => {
		console.log("[prehit] IO callback fired, entries:", entries.length);
		...
		console.log("[prehit] accumulated:", accumulatedElements.length, "received:", receivedCount, "/", observedCount);
		rebuildFromAccumulated();
		if (receivedCount >= observedCount) pendingObserver = null;
	}, { rootMargin: "10000px" });
